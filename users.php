    ...
    <div class="container">
        <nav class="navbar navbar-light bg-light justify-content">
            ...
            <form class="form-inline" method="post">
                <input class="form-control mr-sm-2" type="search" placeholder="Keresés" name="search"
                       value="<?= $search ?>">
        ...
        <?php while ($row = mysqli_fetch_array($userlist)): ?>
            <tr>
                ...
                <td class="justify-content-center">
                    <a class="btn btn-primary btn-sm" href="users-actions.php?UserID=<?= $row['ID'] ?>"><i
                                class="fas fa-edit"></i> Szerk.</a>
                    <a class="btn btn-primary btn-sm" href="users-actions.php?UserID=<?= $row['ID'] ?>&delete=1"><i
                                class="fas fa-trash-alt"></i> Töröl</a>
                </td>
            </tr>
        <?php endwhile; ?>
        </tbody>
